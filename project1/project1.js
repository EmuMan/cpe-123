...
function draw() {
  ...
  push();
  translate(-33.165401458740234, 729.0098876953125, -73.4967269897461);
  rotateZ(-2.8742969036102295);
  rotateY(0.06167509779334068);
  rotateX(1.5804106808621408);
  fill(225.14545798301697, 78.76693099737167, 13.129665367305279);
  box(27.525163650512695, 13.221393585205078, 77.77368927001953);
  pop();

  push();
  translate(-33.925819396972656, 728.9238891601562, -61.25260543823242);
  rotateZ(-2.8742969036102295);
  rotateY(0.06167509779334068);
  rotateX(1.5804106808621408);
  fill(225.14545798301697, 78.76693099737167, 13.129665367305279);
  box(22.690135955810547, 14.192179679870605, 30.89574432373047);
  pop();

  push();
  translate(-43.71891784667969, 726.2391357421875, -62.17753982543945);
  rotateZ(-2.875983715057373);
  rotateY(-0.11353767663240433);
  rotateX(1.5804545871335984);
  fill(225.14545798301697, 78.76693099737167, 13.129665367305279);
  box(4.855676174163818, 14.192179679870605, 30.8957462310791);
  pop();

  push();
  translate(-24.101669311523438, 731.6112670898438, -60.921504974365234);
  rotateZ(-6.014165878295898);
  rotateY(-0.23688769340515137);
  rotateX(1.560924572998655);
  fill(225.14545798301697, 78.76693099737167, 13.129665367305279);
  box(4.855676651000977, 14.192177772521973, 30.8957462310791);
  pop();

  push();
  translate(-29.41461944580078, 713.338134765625, -61.76621627807617);
  rotateZ(-7.614864349365234);
  rotateY(-0.4280170500278473);
  rotateX(1.6385958633739472);
  fill(225.14545798301697, 78.76693099737167, 13.129665367305279);
  box(4.855676174163818, 14.722347259521484, 22.86030387878418);
  pop();

  push();
  translate(-37.95124816894531, 744.5835571289062, -62.077049255371094);
  rotateZ(-10.701522827148438);
  rotateY(-0.4088321924209595);
  rotateX(1.5035738936979295);
  fill(225.14545798301697, 78.76693099737167, 13.129665367305279);
  box(4.855676174163818, 14.722347259521484, 22.86030387878418);
  pop();

  push();
  translate(-50.820465087890625, 765.2515869140625, -72.52857208251953);
  rotateZ(-2.8742969036102295);
  rotateY(0.06167509779334068);
  rotateX(3.1512070439178466);
  fill(255.0, 255.0, 255.0);
  cylinder(1.7007977962493896, 1.8100782632827759, 24, 1, true, true);
  pop();

  push();
  translate(-36.37733840942383, 769.206787109375, -71.60382080078125);
  rotateZ(-2.8742969036102295);
  rotateY(0.06167509779334068);
  rotateX(3.1512070439178466);
  fill(255.0, 255.0, 255.0);
  ...
  push();
  translate(-28.84490203857422, 711.0323486328125, -60.802268981933594);
  rotateZ(-13.898050308227539);
  rotateY(-0.4280169904232025);
  rotateX(1.6385958633739472);
  fill(255.0, 255.0, 255.0);
  box(0.6378598213195801, 12.713203430175781, 19.740581512451172);
  pop();
  ...
  push();
  translate(-23.453563690185547, 739.0117797851562, -59.83357620239258);
  rotateZ(-6.014165878295898);
  rotateY(-0.23688769340515137);
  rotateX(1.560924572998655);
  fill(255.0, 255.0, 255.0);
  box(0.4978686571121216, 10.02738094329834, 9.723295211791992);
  pop();

  push();
  translate(-19.62624168395996, 725.003173828125, -59.694217681884766);
  rotateZ(-6.014165878295898);
  rotateY(-0.23688769340515137);
  rotateX(1.560924572998655);
  fill(255.0, 255.0, 255.0);
  ...
  push();
  translate(-47.79050064086914, 732.3471069335938, -61.39179992675781);
  rotateZ(-9.159170150756836);
  rotateY(-0.11353767663240433);
  rotateX(1.5804545470867277);
  fill(255.0, 255.0, 255.0);
  box(0.4978686273097992, 10.02738094329834, 9.723296165466309);
  pop();

  push();
  translate(-43.96318054199219, 718.3385009765625, -61.25244140625);
  rotateZ(-9.159170150756836);
  rotateY(-0.11353767663240433);
  rotateX(1.5804545470867277);
  fill(255.0, 255.0, 255.0);
  ...
  push();
  translate(-25.952312469482422, 757.5505981445312, -78.39932250976562);
  rotateZ(0.11255156248807907);
  rotateY(-1.633215308189392);
  rotateX(-1.41634909888916);
  fill(49.209992811083794, 92.33493134379387, 171.831157207489);
  cylinder(5.598690986633301, 2.8385844230651855, 24, 1, true, true);
  pop();

  push();
  translate(-12.8938627243042, 709.7545776367188, -77.92384338378906);
  rotateZ(0.11255156248807907);
  rotateY(-1.633215308189392);
  rotateX(-1.41634909888916);
  fill(49.209992811083794, 92.33493134379387, 171.831157207489);
  ...
  push();
  translate(-53.135658264160156, 750.1064453125, -80.1397933959961);
  rotateZ(0.11255156248807907);
  rotateY(-1.633215308189392);
  rotateX(-1.41634909888916);
  fill(49.209992811083794, 92.33493134379387, 171.831157207489);
  ...
  push();
  translate(-40.07720947265625, 702.3104858398438, -79.66431427001953);
  rotateZ(0.11255156248807907);
  rotateY(-1.633215308189392);
  rotateX(-1.41634909888916);
  fill(49.209992811083794, 92.33493134379387, 171.831157207489);
  ...
  push();
  translate(-30.228363037109375, 689.8811645507812, -71.77877807617188);
  rotateZ(-2.8742969036102295);
  rotateY(0.06167509779334068);
  rotateX(3.1512070439178466);
  fill(165.75136184692383, 28.34533330053091, 18.352048136293888);
  ...
  push();
  translate(-15.785236358642578, 693.8363647460938, -70.8540267944336);
  rotateZ(-2.8742969036102295);
  rotateY(0.06167509779334068);
  rotateX(3.1512070439178466);
  fill(165.75136184692383, 28.34533330053091, 18.352048136293888);
